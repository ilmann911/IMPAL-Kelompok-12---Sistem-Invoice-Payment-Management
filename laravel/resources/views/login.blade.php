...
<body class="bg-blue-500 h-screen flex items-center justify-center">
    <div class="bg-white p-10 rounded-2xl shadow-2xl w-full max-auto flex max-w-4xl overflow-hidden">
        ...
        <div class="w-full md:w-1/2 p-8">
            ...
            <form action="/login" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email" class="w-full border p-2 rounded focus:outline-blue-500" placeholder="admin@infopay.com" required>
                </div>
                <div class="mb-6">
